...
class DeoxyfluorinationLoader(ChemistryDatasetLoader):
    """
    Dataset loader for the deoxyfluorination dataset.
    """
    def __init__(self, variable_names: List[str], target: str, enhance: bool = True, prefix: str = ""):
        super().__init__(dataset_name="Deoxyfluorination")
        self.model_path = prefix + 'src/currybo/test_functions/chemistry_datasets/deoxyfluorination.pkl'
        if enhance:
            self.csv_path = prefix + 'src/currybo/test_functions/chemistry_datasets/deoxyfluorination_enhanced.csv'
        else:
            self.csv_path = prefix + 'src/currybo/test_functions/chemistry_datasets/deoxyfluorination_cleaned.csv'
