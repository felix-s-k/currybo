...
def run_benchmark(dataset: ChemistryDatasetLoader, num_samples: list, i: int, budget: int, threshold: float):
    ...
    try:
        ...
        if os.path.exists(f"{dataset.dataset_name}_sequential_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt"):
            campaign_seq.load_from_file(f"{dataset.dataset_name}_sequential_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        campaign_seq.run_optimization(budget=NUM_BUDGET, num_seeds=1, random_seed=i, save_file=f"{dataset.dataset_name}_sequential_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        campaign_seq.save(f"{dataset.dataset_name}_sequential_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        ...
        if os.path.exists(f"{dataset.dataset_name}_w_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt"):
            campaign_w_random.load_from_file(f"{dataset.dataset_name}_w_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        campaign_w_random.run_optimization(budget=NUM_BUDGET, num_seeds=1, random_seed=i, save_file=f"{dataset.dataset_name}_w_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        campaign_w_random.save(f"{dataset.dataset_name}_w_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        ...
        if os.path.exists(f"{dataset.dataset_name}_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt"):
            campaign_random.load_from_file(f"{dataset.dataset_name}_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        campaign_random.run_optimization(budget=NUM_BUDGET, num_seeds=1, random_seed=i, save_file=f"{dataset.dataset_name}_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        campaign_random.save(f"{dataset.dataset_name}_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
        ...
        campaign_all_random.save(f"{dataset.dataset_name}_all_random_{i}{'_enhance' if dataset.enhanced else ''}_frac.pt")
